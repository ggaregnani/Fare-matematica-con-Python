...
linguaggio e, in particolare, l'importanza del **contesto** e il principio di **autoregressione**.

## Probabilità e linguaggio
I language model LM sono modelli 
che predicono data una sequenza di parole la parola successiva.

Possiamo stimare la probabilità di trovare una parola type tramite la frequenza 
relativa, definizione statistica di probabilità, ma per comprendere 
i modelli di linguaggio dobbiamo introdurre il concetto di probabilità 
condizionata e di probabilità dell'evento intersezione in caso di eventi 
